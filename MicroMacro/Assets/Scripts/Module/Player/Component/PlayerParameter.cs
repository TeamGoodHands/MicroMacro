...
namespace Module.Player.Component
{
    ...
    public class PlayerParameter : MonoBehaviour
    {
        ...
        [SerializeField, Header("X軸の最大速度"),FormerlySerializedAs("maxSpeed")]
        private float maxSpeedX;

        [SerializeField, Header("Y軸の最大速度")] private float maxSpeedY;
        ...
        public float MaxSpeedX => maxSpeedX;
        public float MaxSpeedY => maxSpeedY;
