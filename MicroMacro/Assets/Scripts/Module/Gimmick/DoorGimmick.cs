...
namespace Module.Gimmick
{
    ...
    {
        [Header("Targets")] [SerializeField] private GameObject nuts;
        [SerializeField] private GameObject startPoint;
        [SerializeField] private GameObject endPoint;

        [Header("Components")] [SerializeField]
        private Animator warmAnim;
        ...
        [Header("ギミック中切り替えるLayer & Z軸オフセット")] [SerializeField]
        private int ignoreLayerIndex = 2;
        ...
        private PeriodicSoundManager periodicSound = new PeriodicSoundManager();
        ...
        private async UniTaskVoid EatNutsAndBreakDoorFlow()
        {
            ...
            try
            {
                ...
                periodicSound.Play("イモムシ足音", 0.4f);
                ...
                periodicSound.PlayForDurationAsync("食べる音", 0.3f, 1.5f).Forget();
        ...
        // 木の実をかじったときに呼ばれるイベント
        private void OnEatNuts()
        {
            SoundManager.instance.Play("食べる音");
        }
